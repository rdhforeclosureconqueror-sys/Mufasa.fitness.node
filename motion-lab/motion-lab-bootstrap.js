(function (window, document) { "use strict";
  ...
  async function initialize() {
    if (loaded) { var existing=window.MotionLabRuntime?.initialize(); window.PocketPTMotionLabInspection?.wireButtons?.(); return existing; }
    ...
    try {
      ...
      boundary.mount(); await boundary.retry(); loaded=true; window.MotionLabRuntime.initialize(); window.PocketPTMotionLabInspection?.wireButtons?.();
