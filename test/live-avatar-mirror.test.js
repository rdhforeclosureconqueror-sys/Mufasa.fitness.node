...
test("sequential MoveNet frames drive the full bilateral rendered hierarchy and recover safely",()=>{
  ...
  const e=new Events(),session={THREE,avatar,unloadMotion(){}},mirror=new LiveAvatarMirror({eventTarget:e,session,solverOptions:{smoothingLambda:1000,holdMs:50}});mirror.calibration.state="READY";
