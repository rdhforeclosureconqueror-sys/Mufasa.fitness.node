...
test("diagnostic reports every verification category and the exact enforced failure",()=>{
  ...
  assert.deepEqual(report.qualifications,{"greatness.activity.completed":false,runCountAchievements:false,distanceAchievements:false,trailExploration:false,verifiedTrailVisit:false,trailPhotoContributionEligibility:false});
