...
Generated: 2026-04-28T22:22:46.693Z
...
|---|---|---|---|---|---|
| index.html:1222 | POST | dynamic | external/unknown | no/unknown | no |
| index.html:2375 | GET | dynamic | external/unknown | no/unknown | no |
| index.html:2920 | POST | dynamic | external/unknown | yes/conditional | no |
| index.html:2942 | GET | dynamic | external/unknown | yes/conditional | no |
| index.html:3352 | POST | dynamic | external/unknown | yes/conditional | no |
| index.html:3654 | GET | /health | relative origin | no/unknown | no |
| index.html:3802 | POST | dynamic | external/unknown | no/unknown | no |
| index.html:3856 | POST | dynamic | external/unknown | no/unknown | no |
| index.html:5147 | POST | dynamic | external/unknown | yes/conditional | no |
...
| public/index.html:1222 | POST | dynamic | external/unknown | no/unknown | no |
| public/index.html:2375 | GET | dynamic | external/unknown | no/unknown | no |
| public/index.html:2920 | POST | dynamic | external/unknown | yes/conditional | no |
| public/index.html:2942 | GET | dynamic | external/unknown | yes/conditional | no |
| public/index.html:3352 | POST | dynamic | external/unknown | yes/conditional | no |
| public/index.html:3654 | GET | /health | relative origin | no/unknown | no |
| public/index.html:3802 | POST | dynamic | external/unknown | no/unknown | no |
| public/index.html:3856 | POST | dynamic | external/unknown | no/unknown | no |
| public/index.html:5147 | POST | dynamic | external/unknown | yes/conditional | no |
