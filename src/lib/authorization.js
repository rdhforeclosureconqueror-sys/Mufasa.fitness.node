...
const PERMISSIONS = Object.freeze({
  ...
  CLIENT_CRM_READ: "client.crm.read",
  CLIENT_MESSAGES_WRITE: "client.messages.write",
...
const ROLE_PERMISSIONS = Object.freeze({
  ...
  [ROLES.OPERATOR]: [PERMISSIONS.OPS_READ_OBSERVABILITY, PERMISSIONS.OPS_READ_AUTHZ],
  [ROLES.TRAINER]: [PERMISSIONS.TRAINER_WORKSPACE_READ, PERMISSIONS.TRAINER_CLIENTS_READ,
    ...
    PERMISSIONS.TRAINER_CLIENT_NOTES_WRITE, PERMISSIONS.CLIENT_CRM_READ, PERMISSIONS.CLIENT_MESSAGES_WRITE],
  [ROLES.USER]: []
});
