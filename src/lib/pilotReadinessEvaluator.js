...
function evaluatePilotReadiness(report = {}) {
  ...
  const hasWorkoutStartSignal = runtime.selectedExercise != null;
  ...
  const hasWorkoutCompletionSignal = Boolean(runtime.lastFormResultSummary) || Boolean(sessionSaveFailure === null && payload?.errors);
  ...
  if (report?.openAiSummaryStatus !== "ok") {
