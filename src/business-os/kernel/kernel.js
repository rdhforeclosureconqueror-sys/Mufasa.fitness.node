...
function createConstitutionalKernel({clock=()=>new Date(),id=()=>crypto.randomUUID(),handlerTimeoutMs=100,repository=createKernelRepository()}={}){
 ...
 return Object.freeze({registerActor,issueGrant,revokeGrant,addPolicy,createWork,setKillSwitch,promoteEvidence,authorize,recordExternalEvidence,execute,deliverOutbox,repository,contracts:C});
}
