...
const EconomicAssessment=define("EconomicAssessment",["id","organizationId","workId","knownCost","estimatedCost","unknownCosts","expectedValue","actualValue","grossContribution","capacityCost","riskExposure","breakEvenAssumptions","sensitivity","disposition","evidenceRefs","limitations","createdAt"]);
