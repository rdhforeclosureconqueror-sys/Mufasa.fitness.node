...
function unavailableRoute(place,targetDistanceMeters){return{routeSource:"place_only",routeSourceLabel:"Place location only",routeType:null,targetDistanceMeters,estimatedDistanceMeters:null,polyline:[],startPoint:place?{latitude:place.latitude,longitude:place.longitude}:null,turnaroundPoint:null,endPoint:null,loopCount:null,warnings:["This location is available, but a reliable route could not be generated."],confidence:"unavailable"};}
