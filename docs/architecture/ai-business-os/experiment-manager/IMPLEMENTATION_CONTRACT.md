> Target design from planning PR #887. This describes the full destination, not completed implementation. See README.md for the current phase status and internal-only limitations.
