(function (root, factory) {
  ...
  const rows = [
    ...
    ['START_POSITION', 'Valid push-up start position', 'Body tracking', ['BODY_VISIBILITY'], 'PocketPT', 'Connect reviewed orientation, top posture and alignment rules. Visible joints alone cannot arm a countdown.'],
