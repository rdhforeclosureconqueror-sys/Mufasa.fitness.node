(function (root, factory) {
  ...
  const rows = [
    ...
    ['MOCAP_BRIDGE', 'LIVE_MOCAP bridge send', 'Body tracking', ['MIRROR_MOTION_READY', 'CONTROL_CHANNEL'], 'Bridge', 'Verify a current versioned packet was sent through the existing bridge.'],
