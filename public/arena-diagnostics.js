(function (root, factory) {
  ...
  const rows = [
    ...
    ['START_POSITION', 'Valid push-up start position', 'Body tracking', ['BODY_VISIBILITY', 'POSE_TOP_CALIBRATION', 'POSE_BOTTOM_CALIBRATION'], 'PocketPT', 'Connect reviewed orientation, top posture and alignment rules. Personal calibration alone cannot validate form or arm a countdown.'],
