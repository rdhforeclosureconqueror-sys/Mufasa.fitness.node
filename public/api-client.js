(function initCanonicalApiClient(global) {
  "use strict";
  global.__MAAT_ASSET_VERSIONS__ = Object.assign(global.__MAAT_ASSET_VERSIONS__ || {}, { "api-client.js": "20260813-authorization-header-canonicalization-v1" });
  ...
  function canonicalHeaders(input, authToken, hasBody) {
  ...
  async function request(path, options) {
    ...
    try {
      ...
      var headers = canonicalHeaders(options.headers, authToken, Boolean(options.body)); var method = (options.method || "GET").toUpperCase(); var crossOrigin = new URL(url).origin !== global.location?.origin;
