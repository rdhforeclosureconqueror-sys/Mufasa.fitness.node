...
module.exports = Object.freeze([
  ...
  ...[["POST","/api/me/challenges/:slug/join"],["GET","/api/me/challenges/active/current"],["PATCH","/api/me/challenges/:userChallengeId/commitment-sessions/:sessionId/reschedule"],["POST","/api/me/challenges/:userChallengeId/commitment-sessions/:sessionId/start-workout"],["PUT","/api/me/challenges/:userChallengeId/activities/:activityId"],["POST","/api/me/challenges/:userChallengeId/days/:dayId/complete"],["PATCH","/api/me/challenges/:userChallengeId/status"]].map(([method,routePath]) => ({ method,path:routePath,authentication:"required",allowedRoles:[],requiredPermissions:[],membership:"not-required",ownership:"authenticated-user-self",featureFlag:null,publicOutput:"owner-scoped-challenge-progress",rateLimit:method==="GET"?null:"20/minute/user",compatibility:null,publicWrite:method==="GET"?null:"server-validated-owner-progress" })),
  ...[
