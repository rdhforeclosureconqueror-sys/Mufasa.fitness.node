...
module.exports = Object.freeze([
  { method:"GET", path:"/admin/launch-readiness.html", authentication:"public-shell", allowedRoles:[], requiredPermissions:[], membership:"not-required", ownership:"api-enforced", featureFlag:null, publicOutput:"static-shell-no-protected-data", rateLimit:null, compatibility:null, publicWrite:null },
  { method:"GET", path:"/admin-avatar-development.html", authentication:"public-shell", allowedRoles:[], requiredPermissions:[], membership:"not-required", ownership:"api-enforced", featureFlag:null, publicOutput:"static-shell-no-protected-data", rateLimit:null, compatibility:null, publicWrite:null },
  { method:"GET", path:"/api/admin/launch-readiness", authentication:"required", allowedRoles:["super_admin","admin","operator"], requiredPermissions:["ops.read_observability"], membership:"not-required", ownership:"privileged", featureFlag:null, publicOutput:"administrative-private", rateLimit:null, compatibility:null, publicWrite:null },
  { method:"PATCH", path:"/api/admin/launch-readiness/:board/:cardId", authentication:"required", allowedRoles:["super_admin","admin"], requiredPermissions:["ops.manage_enforcement"], membership:"not-required", ownership:"privileged", featureFlag:null, publicOutput:"administrative-private", rateLimit:null, compatibility:null, publicWrite:"validated-launch-evidence" },
  ...[["GET","/api/me/guided-experience"],["PATCH","/api/me/guided-experience"]].map(([method,routePath])=>({method,path:routePath,authentication:"required",allowedRoles:[],requiredPermissions:[],membership:"not-required",ownership:"authenticated-user-self",featureFlag:null,publicOutput:"owner-scoped-guide-preferences",rateLimit:null,compatibility:null,publicWrite:method==="PATCH"?"validated-guide-state":null})),
  ...[["GET","/api/me/challenge-participants/push_up"],["PUT","/api/me/challenge-participants/push_up"]].map(([method,routePath])=>({method,path:routePath,authentication:"required",allowedRoles:[],requiredPermissions:[],membership:"not-required",ownership:"authenticated-user-self",featureFlag:null,publicOutput:"owner-scoped-challenge-participant",rateLimit:null,compatibility:null,publicWrite:method==="PUT"?"validated-fitness-level":null})),
  { method:"GET", path:"/workout.html", authentication:"public-shell", allowedRoles:[], requiredPermissions:[], membership:"not-required", ownership:"api-enforced", featureFlag:"ENABLE_AVATAR_FEATURE", publicOutput:"templated-static-shell-no-protected-data", rateLimit:null, compatibility:null, publicWrite:null },
  ...["/admin/members.html","/admin/client.html","/inbox.html"].map(routePath=>({method:"GET",path:routePath,authentication:"public-shell",allowedRoles:[],requiredPermissions:[],membership:"not-required",ownership:"api-enforced",featureFlag:null,publicOutput:"static-shell-no-protected-data",rateLimit:null,compatibility:null,publicWrite:null})),
  ...[["GET","/api/admin/members"],["GET","/api/admin/clients/:clientUserId/overview"],["GET","/api/admin/clients/:clientUserId/intake"],["GET","/api/admin/clients/:clientUserId/assessments"],["POST","/api/admin/clients/:clientUserId/conversation"]].map(([method,routePath])=>({method,path:routePath,authentication:"required",allowedRoles:["super_admin","admin","trainer"],requiredPermissions:[method==="POST"?"client.messages.write":"client.crm.read"],membership:"not-required",ownership:"admin-all-or-assigned-trainer",featureFlag:null,publicOutput:"minimum-necessary-client-crm",rateLimit:method==="POST"?"30/minute":null,compatibility:null,publicWrite:null})),
  ...[["GET","/api/me/conversations"],["GET","/api/me/conversations/:conversationId/messages"],["POST","/api/me/conversations/:conversationId/messages"]].map(([method,routePath])=>({method,path:routePath,authentication:"required",allowedRoles:[],requiredPermissions:[],membership:"not-required",ownership:"conversation-participant",featureFlag:null,publicOutput:"participant-scoped-private",rateLimit:method==="POST"?"30/minute":null,compatibility:null,publicWrite:method==="POST"?"validated-plain-text":null})),
  { method:"GET", path:"/integrations/garvey/launch", authentication:"signed-context-required", allowedRoles:[], requiredPermissions:[], membership:"not-required", ownership:"signed-subject-and-assignment", featureFlag:"GARVEY_INTEGRATION_ENABLED", publicOutput:"redirect-only-after-secret-a-verification", rateLimit:null, compatibility:null, publicWrite:null },
  { method:"POST", path:"/api/dev/motion-lab/session", authentication:"required", allowedRoles:["super_admin","admin","operator"], requiredPermissions:["ops.read_observability"], membership:"not-required", ownership:"privileged", featureFlag:"ENABLE_MOTION_LAB", publicOutput:"navigation-acknowledgement", rateLimit:null, compatibility:null, publicWrite:null },
  ...
  { method:"GET", path:"/api/admin/diagnostics/healthkit/authorize", authentication:"required", allowedRoles:["super_admin","admin"], requiredPermissions:["ops.read_observability"], membership:"not-required", ownership:"privileged", featureFlag:null, publicOutput:"authorization-acknowledgement", rateLimit:null, compatibility:null, publicWrite:null },
  ...[
  ...
  { method: "POST", path: "/api/me/client-diagnostics", authentication: "required", allowedRoles: [], requiredPermissions: [], membership: "not-required", ownership: "authenticated-user", featureFlag: null, publicOutput: "sanitized-acknowledgement", rateLimit: "12/minute/user", compatibility: null, publicWrite: "bounded-non-authoritative-client-evidence" },
  ...
  ...[["GET","/challenges"],["GET","/challenges/:slug"],["GET","/api/challenges"],["GET","/api/challenges/:slug"],["GET","/api/challenge-exercises/:exerciseId"],["GET","/exercise-media/kettlebell/:exerciseId"]].map(([method,routePath]) => ({ method,path:routePath,authentication:"public",allowedRoles:[],requiredPermissions:[],membership:"not-required",ownership:"public-definition-read",featureFlag:null,publicOutput:"published-challenge-or-static-shell",rateLimit:null,compatibility:null,publicWrite:null })),
  ...[["POST","/api/me/challenges/:slug/join"],["GET","/api/me/challenges/active/current"],["GET","/api/me/challenges/:slug/current"],["PATCH","/api/me/challenges/:userChallengeId/commitment-sessions/:sessionId/reschedule"],["POST","/api/me/challenges/:userChallengeId/commitment-sessions/:sessionId/start-workout"],["PUT","/api/me/challenges/:userChallengeId/activities/:activityId"],["POST","/api/me/challenges/:userChallengeId/days/:dayId/complete"],["PATCH","/api/me/challenges/:userChallengeId/status"]].map(([method,routePath]) => ({ method,path:routePath,authentication:"required",allowedRoles:[],requiredPermissions:[],membership:"not-required",ownership:"authenticated-user-self",featureFlag:null,publicOutput:"owner-scoped-challenge-progress",rateLimit:method==="GET"?null:"20/minute/user",compatibility:null,publicWrite:method==="GET"?null:"server-validated-owner-progress" })),
  ...[
