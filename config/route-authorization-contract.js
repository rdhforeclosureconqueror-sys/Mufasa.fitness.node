...
module.exports = Object.freeze([
  { method:"GET", path:"/admin/launch-readiness.html", authentication:"required", allowedRoles:["super_admin","admin","operator"], requiredPermissions:["ops.read_observability"], membership:"not-required", ownership:"privileged", featureFlag:null, publicOutput:"admin-only-page", rateLimit:null, compatibility:null, publicWrite:null },
  { method:"GET", path:"/admin-avatar-development.html", authentication:"required", allowedRoles:["super_admin","admin","operator"], requiredPermissions:["ops.read_observability"], membership:"not-required", ownership:"privileged", featureFlag:null, publicOutput:"admin-only-page", rateLimit:null, compatibility:null, publicWrite:null },
