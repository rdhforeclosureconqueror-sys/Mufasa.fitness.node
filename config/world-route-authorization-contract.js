...
module.exports = Object.freeze([
  ...
  Object.freeze({ method: "GET", path: "/api/game/config", authentication: "public-arena-config", ownership: "no-member-data", publicOutput: "protocol-experience-and-canonical-PocketPT-return-url" }),
  ...
  Object.freeze({ method: "GET", path: "/api/game/avatar/asset", authentication: "http-only-arena-session", ownership: "session-bound-member-current-canonical-avatar", publicOutput: "owner-scoped-avatar-glb", notes: "Versioned, private no-store download. Reuses canonical avatar ownership; no caller-selected member or asset." }),
